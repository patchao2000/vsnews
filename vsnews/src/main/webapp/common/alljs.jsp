...
<script src="${ctx}/assets/javascripts/plugins/bootstrap_daterangepicker/bootstrap-daterangepicker.js"
        type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/common/moment.min.js" type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/bootbox/bootbox.min.js" type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/timeago/jquery.timeago.js" type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/common/wysihtml5.min.js" type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/common/bootstrap-wysihtml5.js" type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
<script src="${ctx}/assets/javascripts/plugins/bootbox/bootbox.min.js" type="text/javascript"></script>
<script>
    (function () {
